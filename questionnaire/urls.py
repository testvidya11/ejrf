...
from questionnaire.views.upload_document import UploadDocument, DownloadDocument
...
urlpatterns = patterns('',
    ...
    url(r'^questionnaire/entry/(?P<questionnaire_id>\d+)/documents/upload/$', UploadDocument.as_view(),
