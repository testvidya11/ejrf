from questionnaire.models import Questionnaire, Section, SubSection, Question, GroupedQuestion, Answer, Country
...
class GroupedAnswerTest(BaseTest):
    def setUp(self):
        ...
        self.grouped_question = GroupedQuestion.objects.create(subsection=self.sub_section,  order=1)
    ...
    def test_grouped_answers_store(self):
        grouped_answers = GroupedAnswer.objects.create(answer=self.answer, grouped_question=self.grouped_question, row=1)
