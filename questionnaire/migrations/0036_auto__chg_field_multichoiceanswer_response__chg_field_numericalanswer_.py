...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MultiChoiceAnswer.response'
        db.alter_column(u'questionnaire_multichoiceanswer', 'response_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questionnaire.QuestionOption'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MultiChoiceAnswer.response'
        db.alter_column(u'questionnaire_multichoiceanswer', 'response_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['questionnaire.QuestionOption']))

        # Changing field 'NumericalAnswer.response'
        db.alter_column(u'questionnaire_numericalanswer', 'response', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=2))

        # Changing field 'DateAnswer.response'
        db.alter_column(u'questionnaire_dateanswer', 'response', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 2, 11, 0, 0)))
