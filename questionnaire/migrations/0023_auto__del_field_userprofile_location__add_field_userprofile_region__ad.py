...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'questionnaire_userprofile', 'location')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'questionnaire_userprofile', 'location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.region'
        db.delete_column(u'questionnaire_userprofile', 'region')

        # Deleting field 'UserProfile.country'
        db.delete_column(u'questionnaire_userprofile', 'country')
