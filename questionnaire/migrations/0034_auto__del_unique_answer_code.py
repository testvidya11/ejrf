...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Answer', fields ['code']
        db.delete_unique(u'questionnaire_answer', ['code'])


    def backwards(self, orm):
        # Adding unique constraint on 'Answer', fields ['code']
        db.create_unique(u'questionnaire_answer', ['code'])
