...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionGroup.grid'
        db.add_column(u'questionnaire_questiongroup', 'grid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'QuestionGroup.display_all'
        db.add_column(u'questionnaire_questiongroup', 'display_all',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionGroup.grid'
        db.delete_column(u'questionnaire_questiongroup', 'grid')

        # Deleting field 'QuestionGroup.display_all'
        db.delete_column(u'questionnaire_questiongroup', 'display_all')
