...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionOption.UID'
        db.add_column(u'questionnaire_questionoption', 'UID',
                      self.gf('django.db.models.fields.CharField')(max_length=6, unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionOption.UID'
        db.delete_column(u'questionnaire_questionoption', 'UID')
