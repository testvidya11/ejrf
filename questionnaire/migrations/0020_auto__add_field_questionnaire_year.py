...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Questionnaire.year'
        db.add_column(u'questionnaire_questionnaire', 'year',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Questionnaire.year'
        db.delete_column(u'questionnaire_questionnaire', 'year')
