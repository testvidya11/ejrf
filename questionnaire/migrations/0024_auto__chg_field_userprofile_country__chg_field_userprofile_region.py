...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'questionnaire_userprofile', 'country', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'UserProfile.region'
        db.alter_column(u'questionnaire_userprofile', 'region', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.country'
        db.alter_column(u'questionnaire_userprofile', 'country', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'UserProfile.region'
        db.alter_column(u'questionnaire_userprofile', 'region', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
