...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QuestionGroup.order'
        db.delete_column(u'questionnaire_questiongroup', 'order')

        # Adding field 'QuestionGroup.parent'
        db.add_column(u'questionnaire_questiongroup', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questionnaire.QuestionGroup'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'QuestionGroup.order'
        db.add_column(u'questionnaire_questiongroup', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'QuestionGroup.parent'
        db.delete_column(u'questionnaire_questiongroup', 'parent_id')
    ...
    models = {
        ...
        'questionnaire.questiongroup': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['questionnaire.QuestionGroup']", 'null': 'True'}),
