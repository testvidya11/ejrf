...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'questionnaire_userprofile', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questionnaire.Region'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.country'
        db.add_column(u'questionnaire_userprofile', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questionnaire.Country'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.organization'
        db.add_column(u'questionnaire_userprofile', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['questionnaire.Organization'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.region'
        db.delete_column(u'questionnaire_userprofile', 'region_id')

        # Deleting field 'UserProfile.country'
        db.delete_column(u'questionnaire_userprofile', 'country_id')

        # Deleting field 'UserProfile.organization'
        db.delete_column(u'questionnaire_userprofile', 'organization_id')
