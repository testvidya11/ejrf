...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.is_core'
        db.add_column(u'questionnaire_question', 'is_core',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Question.is_primary'
        db.add_column(u'questionnaire_question', 'is_primary',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.is_core'
        db.delete_column(u'questionnaire_question', 'is_core')

        # Deleting field 'Question.is_primary'
        db.delete_column(u'questionnaire_question', 'is_primary')
