...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.short_instruction'
        db.add_column(u'questionnaire_question', 'short_instruction',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.short_instruction'
        db.delete_column(u'questionnaire_question', 'short_instruction')
