...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionOption.instructions'
        db.add_column(u'questionnaire_questionoption', 'instructions',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionOption.instructions'
        db.delete_column(u'questionnaire_questionoption', 'instructions')
