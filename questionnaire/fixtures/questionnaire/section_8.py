...
question2 = Question.objects.create(text="Round and type of activity", UID='C00130', answer_type='Text',
...
question3 = Question.objects.create(text="Date", UID='C00131', answer_type='Date')
...
question6 = Question.objects.create(text="Estimated number in target population", UID='C00134', answer_type='Number')
question7 = Question.objects.create(text="Total number of persons vaccinated or supplemented", UID='C00135', answer_type='Number')
...
question14 = Question.objects.create(text="TT4 or more", UID='C00140', answer_type='Number')
